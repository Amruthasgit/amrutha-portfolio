...
const typed = new Typed('.multiple-text',{
    strings:['I am a Grad Student at UtDallas Jinadal School of Management ','I am experienced in Full stack Development,Data science, and many latest technologies'],
    typeSpeed:80,
    backSpeed:30,
    backDelay:1000,
    loop:true
